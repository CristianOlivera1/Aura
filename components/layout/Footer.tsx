...
export function Footer() {
  return (
    <footer className="border-t border-muted relative overflow-hidden">
      <div
      ...
      <div className="mx-auto max-w-7xl w-full px-6 py-14 relative z-10">
        ...
        <p className="text-lg text-muted-fg mt-3 max-w-md">
          A small library of ambient gradient backgrounds. Free and open source —
          animated and customizable gradients are on the way.
        </p>
